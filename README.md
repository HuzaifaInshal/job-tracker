...
JobTrack is a multi-platform job application tracker. Log every application, manage statuses, track interview timelines, and stay on top of your job search — all in one place.
...
```
job-tracker/
├── web application/   # Next.js web app
...
Clone the repository and refer to the platform-specific README for setup instructions.
