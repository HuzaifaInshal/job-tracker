...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080b12] text-slate-100 overflow-x-hidden">
      ...
      {/* ── Navbar ── */}
      <nav className="relative z-20 flex items-center justify-between px-6 md:px-12 py-5 max-w-9xl mx-auto">
      ...
      {/* ── Hero ── */}
      <section className="relative z-10 max-w-9xl mx-auto px-6 md:px-12 pt-16 pb-8 md:pt-24 md:pb-12">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Headline */}
          <h1
            className={`font-display text-5xl sm:text-6xl md:text-7xl lg:text-[82px] font-800 leading-[1.04] tracking-[-0.03em] mb-6 max-w-5xl ${mounted ? "animate-fade-up-2" : "opacity-0"}`}
          >
          ...
          {/* CTAs */}
          <div
            className={`flex flex-col sm:flex-row items-center gap-3 mb-16 ${mounted ? "animate-fade-up-4" : "opacity-0"}`}
          >
            <Link
              href="/get-started"
          ...
          {/* App Preview Mockup */}
          <div
            className={`relative w-full max-w-4xl ${mounted ? "animate-fade-up-5" : "opacity-0"}`}
          >
            {/* Glow behind mockup */}
                ...
                {MOCK_APPS.map((app, i) => (
                  <div
                    ...
                    style={{
                      ...
                      opacity: mounted ? 1 : 0,
                      animation: mounted
                        ? `fade-up 0.5s ${app.delay} ease both`
                        : "none"
                    }}
                  >
                    <span
            ...
            {/* Floating cards */}
            <div
              className="hidden md:block absolute -right-12 top-12 w-52 rounded-xl border border-[#1e2d45] bg-[#0f1428] p-3.5 shadow-xl animate-float-slow"
            ...
            <div
              className="hidden md:block absolute -left-10 bottom-16 w-44 rounded-xl border border-[#1e2d45] bg-[#0f1428] p-3 shadow-xl animate-float-slow"
            ...
            >
              ...
              <div className="text-2xl font-display font-800 text-white">
                24
              </div>
      ...
      <section
        id="features"
        className="relative z-10 max-w-9xl mx-auto px-6 md:px-12 py-24"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              />
              <div
                className={`h-10 w-10 rounded-xl border ${f.border} bg-black/20 flex items-center justify-center mb-4 text-white`}
              >
                {f.icon}
              </div>
      ...
      {/* ── Stats ── */}
      <section className="relative z-10 max-w-9xl mx-auto px-6 md:px-12 py-16">
        <div className="rounded-3xl border border-[#1e2d45] bg-[#0a0d18] p-10 md:p-16 relative overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 right-0 w-96 h-116 rounded-full bg-blue-600/5 blur-3xl" />
          ...
          <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-10 text-center">
            {[
              { value: "100%", label: "Free to use", sub: "No paywalls, ever" },
              {
                value: "∞",
                label: "Applications",
                sub: "Track as many as you need"
              },
              {
                value: "1 min",
                label: "Setup time",
                sub: "Sign in and start immediately"
              }
            ].map((s) => (
              <div key={s.value}>
      ...
      <section className="relative z-10 max-w-9xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={step.step}
              className="relative rounded-2xl border border-[#1e2d45] bg-[#0a0d18] p-7"
            >
              <div className="flex items-center gap-3 mb-5">
                <span className="font-display text-3xl font-800 text-[#1e2d45]">
                  {step.step}
                </span>
                <div className="h-11 w-9 rounded-xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center text-blue-400">
                  {step.icon}
                </div>
              </div>
      ...
      {/* ── CTA ── */}
      <section className="relative z-10 max-w-9xl mx-auto px-6 md:px-12 py-16 pb-24">
      ...
      {/* ── Footer ── */}
      <footer className="relative z-10 border-t border-[#1a2235] px-6 md:px-12 py-8 max-w-9xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <Briefcase className="h-4 w-4 text-blue-400" />
